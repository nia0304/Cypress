...
describe("admin pmb can login and open all page in module PMB", () => {
    ...
    it("admin can open menu di modul spmb", () => {
        //dashboard
        cy.visit("spmb/home");
        ...
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Pendaftar");
        ...
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Periode Pendaftaran");

        cy.visit("spmb/ms_prodi");
        cy.get(".content-header > h1 > small").should("contain.text", "Sebaran Program Studi");

        cy.visit("spmb/ms_seleksipendaftaran");
        cy.get(".content-header > h1 > small").should("contain.text", "Seleksi Pendaftaran");

        cy.visit("spmb/ms_syaratpendaftaran");
        cy.get(".content-header > h1 > small").should("contain.text", "Syarat Seleksi");

        cy.visit("spmb/list_jadwal");
        cy.get(".content-header > h1 > small").should("contain.text", "Jadwal");

        cy.visit("spmb/ms_kelompokukt");
        cy.get(".content-header > h1").should("contain.text", "Kelompok & Tarif UKT");

        //seleksi
        cy.visit("spmb/list_nilaiseleksi");
        cy.get(".content-header > h1 > small").should("contain.text", "Nilai Seleksi");
        ...
        cy.get(".content-header > h1 > small").should("contain.text", "Hasil Seleksi");

        cy.visit("spmb/set_syaratseleksi");
        cy.get(".content-header > h1 > small").should("contain.text", "Administrasi");

        cy.visit("spmb/set_uktpendaftar");
        cy.get(".content-header > h1").should("contain.text", "UKT Pendaftar");

        cy.visit("spmb/set_bidikmisi");
        cy.get(".content-header > h1").should("contain.text", "KIP Kuliah Pendaftar");

        //kelulusan
        cy.visit("spmb/list_kelulusan");
        cy.get(".content-header > h1 > small").should("contain.text", "Rekomendasi Prodi");

        cy.visit("spmb/set_registrasi");
        cy.get(".content-header > h1 > small").should("contain.text", "Registrasi Ulang");

        cy.visit("spmb/set_mahasiswa");
        cy.get(".content-header > h1 > small").should("contain.text", "Generate Mahasiswa");

        cy.visit("spmb/ms_batalnim");
        cy.get(".content-header > h1 > small").should("contain.text", "Pembatan NIM");
        ...
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Pengumuman & Informasi");

        cy.visit("spmb/ms_linkterkait");
        cy.get(".content-header > h1 > small").should("contain.text", "Tautan Terkait");

        cy.visit("spmb/list_broadcast");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Broadcast");

        //Referensi > seleksi
        cy.visit("spmb/ms_jenisseleksi");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Jenis Seleksi");
        ...
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Jenis Institusi");

        cy.visit("spmb/list_sekolah");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Sekolah");
        ...
        cy.get(".content-header > h1").should("contain.text", "Prodi Perguruan Tinggi");

        //Referensi > wilayah
        cy.visit("spmb/ms_negara");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Negara");

        cy.visit("spmb/ms_propinsi");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Propinsi");

        cy.visit("spmb/ms_kota");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Kota");

        cy.visit("spmb/ms_kecamatan");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Kecamatan");
        ...
        cy.get(".content-header > h1").should("contain.text", "Pemberi Rekomendasi");

        cy.visit("spmb/list_pertanyaan");
        cy.get(".content-header > h1 > small").should("contain.text", "Daftar Pertanyaan");
        ...
        cy.get(".content-header > h1").should("contain.text", "Laporan Biodata Pendaftar");

        cy.visit("spmb/repp_uktpendaftar");
        cy.get(".content-header > h1").should("contain.text", "Laporan UKT Pendaftar");

        cy.visit("spmb/repp_pendaftarbidikmisi");
        cy.get(".content-header > h1").should("contain.text", "Laporan Pendaftar KIP Kuliah");
        ...
        cy.get(".content-header > h1").should("contain.text", "Pilihan Prodi Pendaftar");

        cy.visit("spmb/repp_perekomendasi");
        cy.get(".content-header > h1").should("contain.text", "Perekomendasi Pendaftar");

        cy.visit("spmb/repp_hitunguktpendaftar");
        cy.get(".content-header > h1").should("contain.text", "Laporan Perhitungan UKT Pendaftar");

        //Laporan > seleksi
        cy.visit("spmb/repp_nilaiseleksi");
        cy.get(".content-header > h1").should("contain.text", "Laporan Nilai Seleksi Pendaftar");
        ...
        cy.get(".content-header > h1").should("contain.text", "Daftar Hadir Seleksi");
        ...
        cy.get(".content-header > h1").should("contain.text", "Laporan Rekomendasi Prodi");

        cy.visit("spmb/repp_daftarulang");
        cy.get(".content-header > h1").should("contain.text", "Laporan Daftar Ulang");

        //Laporan > rekapitulasi
        cy.visit("spmb/repp_rekapprodi");
        cy.get(".content-header > h1").should("contain.text", "Rekap Prodi Pendaftar");

        cy.visit("spmb/repp_kuotaukt");
        cy.get(".content-header > h1").should("contain.text", "Rekap Kuota UKT");

        cy.visit("spmb/repp_rekapbidikmisi");
        cy.get(".content-header > h1").should("contain.text", "Rekap Pendaftar KIP Kuliah");

        cy.visit("spmb/repp_rekaprekomprodi");
        cy.get(".content-header > h1").should("contain.text", "Rekap Rekomendasi Prodi");

        cy.visit("spmb/repp_rekapsekolah");
        cy.get(".content-header > h1").should("contain.text", "Rekap Sekolah Pendaftar");

        cy.visit("spmb/repp_rekapkota");
        cy.get(".content-header > h1").should("contain.text", "Rekap Kota Pendaftar");

        cy.visit("spmb/repp_kuisionerpendaftar");
        cy.get(".content-header > h1").should("contain.text", "Laporan Kuesioner Pendaftar");
