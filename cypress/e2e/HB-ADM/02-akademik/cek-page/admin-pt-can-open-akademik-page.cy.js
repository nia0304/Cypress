...
describe("admin pt can login and open all page in akademik aplikasi module", () => {
    beforeEach(() => {
        cy.loginsuperadmin();
        ...
        cy.get('#siakad > div > div:nth-child(3)').click();
        cy.wait("@adminAccess").its("response.statusCode").should("equal", 200);
    });

    it("admin pt can open dashboard akademik aplikasi module", () => {
    ...
    it("admin pt can open menu laporan administrasi - laporan emis di modul akademik aplikasi", () => {
