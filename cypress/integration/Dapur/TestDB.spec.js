describe('Tes Reset Database', () => {
    before(() => {
        ...
        cy.exec("psql -U postgres -d siakad_lokal -c 'DROP Schema spmb cascade'");
  
        cy.exec(
          'pg_restore --clean --if-exist --format=custom --dbname=siakad_lokal "./cypress/fixtures/db/tes.dump"'
        );
    });
    it('tambah peserta', () => {
    ...
    //peserta
        cy.get('#idperiodedaftar').select('2020/2021 Genap - Gelombang 3 - Mandiri - Reguler A - Mandiri 20/21 Genap Gel 3').wait(0)
